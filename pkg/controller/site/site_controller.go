...
import (
	...
	hugov1alpha1 "github.com/philipsahli/hugo-operator/pkg/apis/hugo/v1alpha1"
	...
	"github.com/philipsahli/hugo-operator/src"
)
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &hugov1alpha1.Site{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner Site
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &hugov1alpha1.Site{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSite) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling Site")

	// Fetch the Site instance
	instance := &hugov1alpha1.Site{}
	...
	reqLogger.Info("Branches list", branches)
	...
	// Set Site instance as the owner and controller
...
func newPodForCR(cr *hugov1alpha1.Site) *corev1.Pod {
